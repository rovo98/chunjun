...
/**
 * kingbase中不常用类型转换为java类型 @Company: www.dtstack.com
 *
...
public class KingBaseTypeConverter implements TypeConverterInterface {
    ...
    private List<String> doubleTypes =
            Arrays.asList("double precision", "double", "float8", "money");

    private List<String> intTypes =
            Arrays.asList(
                    "int", "int2", "int4", "int8", "integer", "bigint", "bigserial", "smallint");
