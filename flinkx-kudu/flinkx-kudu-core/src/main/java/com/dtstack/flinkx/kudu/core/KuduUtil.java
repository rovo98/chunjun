...
public class KuduUtil {
    ...
    private static String EXPRESS_REGEX =
     ...
     */
    public static KuduClient getKuduClient(KuduConfig config, Map<String, Object> hadoopConfig)
    ...
    private static KuduClient getKuduClientInternal(KuduConfig config) {
        return new AsyncKuduClient.AsyncKuduClientBuilder(
                        Arrays.asList(config.getMasterAddresses().split(",")))
