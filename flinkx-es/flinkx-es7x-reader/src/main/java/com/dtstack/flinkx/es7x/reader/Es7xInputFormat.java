 ...
 */
public class Es7xInputFormat extends BaseRichInputFormat {
    ...
    private boolean searchScroll() throws IOException {
        ...
        if (scrollId == null) {
            ...
            SearchResponse searchResponse =
                    client.searchScroll(scrollRequest, RequestOptions.DEFAULT);
            scrollId = searchResponse.getScrollId();
            searchHits = searchResponse.getHits().getHits();
        }
    ...
    public Row nextRecordInternal(Row row) throws IOException {
        return Es7xUtil.jsonMapToRow(iterator.next(), columnNames, columnTypes, columnValues);
    }
