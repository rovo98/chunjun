 ...
 */
public class Es6xInputFormat extends BaseRichInputFormat {
    ...
    public void openInternal(InputSplit inputSplit) throws IOException {
        ...
        client = Es6xUtil.getClient(address, username, password, clientConfig);
    ...
    public Row nextRecordInternal(Row row) throws IOException {
        return Es6xUtil.jsonMapToRow(iterator.next(), columnNames, columnTypes, columnValues);
    }
