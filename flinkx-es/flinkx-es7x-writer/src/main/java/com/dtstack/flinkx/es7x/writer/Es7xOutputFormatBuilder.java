 ...
 */
public class Es7xOutputFormatBuilder extends BaseRichOutputFormatBuilder {

    private Es7xOutputFormat format;

    public Es7xOutputFormatBuilder() {
        super.format = format = new Es7xOutputFormat();
    }
    ...
    public Es7xOutputFormatBuilder setClientConfig(Map<String, Object> clientConfig) {
