 ...
 */
public class Es6xOutputFormatBuilder extends BaseRichOutputFormatBuilder {

    private Es6xOutputFormat format;

    public Es6xOutputFormatBuilder() {
        super.format = format = new Es6xOutputFormat();
    }
    ...
    public Es6xOutputFormatBuilder setClientConfig(Map<String, Object> clientConfig) {
