...
public class HbaseHelper {
    ...
    public static org.apache.hadoop.hbase.client.Connection getHbaseConnection(
    ...
    private static org.apache.hadoop.hbase.client.Connection getConnectionWithKerberos(
            Map<String, Object> hbaseConfigMap) {
        try {
